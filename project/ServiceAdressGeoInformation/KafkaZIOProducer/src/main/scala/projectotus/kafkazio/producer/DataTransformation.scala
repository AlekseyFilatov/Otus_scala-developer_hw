...
object DataTransformation {
  ...
  class EventGenerator extends DataTransformation.Service {
  ...
  */
  ...
  object EventGenerator {
    def parserTransactionRaw(parseStr: Iterator[String]): ZIO[EventGenerator, Throwable, Iterator[TransactionRaw]] =
